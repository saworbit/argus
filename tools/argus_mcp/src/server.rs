...
impl ServerHandler for Argus {
    fn get_info(&self) -> ServerInfo {
        ...
        .with_server_info(Implementation::new("argus-mcp", "0.22.0"))
        .with_instructions(
            "Argus lab 0.22. Do not invent a fteqcc/quakespasm/python pipeline. \
